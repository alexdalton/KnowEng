...
genesFile = "/home/alex/KnowEng/data/edges/KN_03.STRING_coexpression_genes.txt"
vectorsFile = "/home/alex/KnowEng/data/dcaVectors.csv"
...
(dict_X, dict_y, positiveKeys, negativeKeys) = dataRetriever.getDCAData(genesFile, vectorsFile, labelFile)

print len(negativeKeys)
